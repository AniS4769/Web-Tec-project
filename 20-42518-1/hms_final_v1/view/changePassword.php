        ...
        <div style="margin:auto;width:23%;background-color:#3498DB;padding-left:2rem;padding-right:2rem;padding-bottom:0.5rem;border-radius: 30px;">
                ...
                <div>
                    ...
                    <form style="margin-left:0rem;" action="../control/changePasswordAction.php" method="post" novalidate id="cp_form" onsubmit="return isValid(this);">
                        ...
                        <br><br><br>
                        <input style="text-color:#e6e6e6;padding-right:10px;padding-left:10px;padding-top:5px;padding-bottom:5px;border-radius: 30px;border:none;font-size:15px;" type="submit" value="Submit" onclick="submitData();">
                    </form>
                </div>
            </div>
        </section>
