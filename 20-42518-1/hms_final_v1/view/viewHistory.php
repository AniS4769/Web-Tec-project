    ...
    <div style="margin:auto;width:50%;background-color:#3498DB;padding-left:2rem;padding-right:2rem;padding-bottom:0.5rem;border-radius: 30px;">
      <div style="margin:auto;">
          ...
          <br>
            ...
            <input style="border:none; border-radius:30px;padding:5px;margin-left:1rem;padding-left:15px;padding-right:15px;" type="button" name="Search" value="Search"  onclick="search(this);">
            <?php
                        if($pIDErr === true){
